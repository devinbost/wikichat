...
const Navbar = ({ llm, setConfiguration, theme, setTheme }: Props): JSX.Element => {
    ...
    return <nav className="flex flex-col md:flex-row gap-3 md:gap-6 rounded-t-3xl bg-primary items-center md:items-start sticky top-0 z-10 p-6 md:px-16 md:pt-4">
